...
parser.add_argument('--device', type=str, default='cpu', help='device to train on, cuda or cpu (default: cpu)')
...
print('using model: efficent_net_v2_s')
...
for epoch in range(start_epoch, args.epochs):
    ...
    val_res = utils.eval(loaders['validation'], model, criterion,device)
